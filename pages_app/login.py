"""
FairSight AI — Login Page (Futuristic AI SaaS Redesign)
"""

import streamlit as st
import base64
from utils.auth import login_user, google_login, handle_callback
    ...
    with right_col:
        st.markdown(
            ...
            <div class="auth-form-wrapper">
                ...
                <div class="auth-subheader">Sign in to your Unbiased AI workspace</div>
            </div>
            """, 
            unsafe_allow_html=True
        )
