...
Paragraph 3 -- RECOMMENDATION:
  ...
  Be concrete -- name the feature to remove or the policy to change."""
    ...
    # On 429 (rate limit), we parse the retry-after seconds from the error
    # message and sleep exactly that long before retrying. If the primary
    # model's daily quota is exhausted we fall back to gemini-2.0-flash-lite.
